...
public class Num12Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Num12Activity.Descrip().execute();
    }
    ...
    private class Descrip extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(Num12Activity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            textView_contents.setText("Capricorn daily lucky number");
            textView_contents2.setText("5 - 1 2 - 1 9 - 2 0 - 2 7 - 3 5 - 4 3");
