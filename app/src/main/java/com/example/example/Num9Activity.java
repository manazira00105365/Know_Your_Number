...
public class Num9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Num9Activity.Descrip().execute();
    }
    ...
    private class Descrip extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(Num9Activity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            textView_contents.setText("Libra daily lucky number");
            textView_contents2.setText("8 - 1 1 - 1 9 - 2 0 - 2 7 - 3 4 - 4 7");
