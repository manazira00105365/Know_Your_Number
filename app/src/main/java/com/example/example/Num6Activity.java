...
public class Num6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Num6Activity.Descrip().execute();
    }
    ...
    private class Descrip extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(Num6Activity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            textView_contents.setText("Cancer daily lucky number");
            textView_contents2.setText("4 - 8 - 1 5 - 2 1 - 2 9 - 3 7 - 4 5");
