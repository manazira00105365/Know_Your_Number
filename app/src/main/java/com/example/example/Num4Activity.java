...
public class Num4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Num4Activity.Descrip().execute();
    }
    ...
    private class Descrip extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(Num4Activity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            textView_contents.setText("Taurus daily lucky number");
            textView_contents2.setText("6 - 1 6 - 1 6 - 2 1 - 2 9 - 4 0 - 4 4");
