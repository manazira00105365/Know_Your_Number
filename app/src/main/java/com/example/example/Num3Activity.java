...
public class Num3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Num3Activity.Descrip().execute();
    }
    private class Descrip extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(Num3Activity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            textView_contents.setText("Aries daily lucky number");
            textView_contents2.setText("7 - 1 4 - 1 8 - 2 3 - 2 7 - 3 6 - 4 1");
