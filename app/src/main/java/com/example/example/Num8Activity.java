...
public class Num8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Num8Activity.Descrip().execute();
    }
    ...
    private class Descrip extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(Num8Activity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            textView_contents.setText("Virgo daily lucky number");
            textView_contents2.setText("1 - 9 - 1 7 - 2 3 - 3 1 - 3 5 - 4 8");
